...
Devise.setup do |config|
  ...
  # config.secret_key = '82234cab37fd1eb6fe00288ccba12af7d2a112aaae6d|
  # 64ee0b8c188a9f93203ba2da9b9b57590238e1f436580a3d155a9c656c46374b8d|
  # af8e45d8d1f56a860e'
  ...
  config.mailer_sender = "do-not-reply@dont_you_like_lehane.com"
  ...
  # of stretches (e.g.
  # a value of 20 is already extremely slow: approx. 60
  # seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = 'cc3eb9e3a973a61965d4ea2d8b2237e451c42d736b2a6f|
  # 9058fc7cd6ccd806a77e97b2d4a90cb240878b975c12db202a83a|
  # 09885bebe6a5eaa3c230c0bdb2039'
